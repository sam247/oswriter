...
import bulkImg from "@/assets/product-bulk.jpg";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.2fr] lg:gap-16">
          ...
          <div>
            <div className="overflow-hidden rounded-xl shadow-[0_30px_80px_-30px_rgba(0,0,0,0.35)] ring-1 ring-black/5">
              <img src={bulkImg} alt="QueueWrite workspace showing the article queue, validation results and SEO checks" className="block w-full" />
            </div>
          </div>
        </div>
      </div>

...
export function KnowledgeBaseSettings({ knowledgeBase, disabledReason, onSave }: KnowledgeBaseSettingsProps) {
  ...
  return (
    <section className="mt-4 rounded-md border border-line bg-surface-1 p-4">
      <div>
        <h2 className="text-[13px] font-semibold text-ink">Knowledge Base <span className="font-normal text-ink-subtle">(Optional)</span></h2>
        <p className="mt-1 text-[11.5px] leading-relaxed text-ink-muted">Provide additional information about your business, services and audience to improve article planning and generation.</p>
      </div>
